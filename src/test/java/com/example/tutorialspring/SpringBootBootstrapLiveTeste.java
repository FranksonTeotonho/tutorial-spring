...
@SpringBootTest(classes = {TutorialSpringApplication.class}, webEnvironment = SpringBootTest.WebEnvironment.DEFINED_PORT)
public class SpringBootBootstrapLiveTeste {
